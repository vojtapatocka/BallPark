...
14    continue
      ...
      SUBROUTINE rkck(y,dydx,n,x,h,yout,yerr,derivs,dp)
      INTEGER n,NMAX
      REAL h,x,dydx(n),y(n),yerr(n),yout(n),dp
      EXTERNAL derivs
      PARAMETER (NMAX=4)
CU    USES derivs
      INTEGER i
...
11    continue
      call derivs(x+A2*h,ytemp,ak2,dp)
      do 12 i=1,n
        ytemp(i)=y(i)+h*(B31*dydx(i)+B32*ak2(i))
12    continue
      call derivs(x+A3*h,ytemp,ak3,dp)
      do 13 i=1,n
        ytemp(i)=y(i)+h*(B41*dydx(i)+B42*ak2(i)+B43*ak3(i))
13    continue
      call derivs(x+A4*h,ytemp,ak4,dp)
      do 14 i=1,n
        ytemp(i)=y(i)+h*(B51*dydx(i)+B52*ak2(i)+B53*ak3(i)+B54*ak4(i))
14    continue
      call derivs(x+A5*h,ytemp,ak5,dp)
      do 15 i=1,n
        ytemp(i)=y(i)+h*(B61*dydx(i)+B62*ak2(i)+B63*ak3(i)+B64*ak4(i)+
     *B65*ak5(i))
15    continue
      call derivs(x+A6*h,ytemp,ak6,dp)
      do 16 i=1,n
...
17    continue
      ...
      SUBROUTINE rkqs(y,dydx,n,x,htry,eps,yscal,hdid,hnext,derivs,dp)
      INTEGER n,NMAX
      REAL eps,hdid,hnext,htry,x,dydx(n),y(n),yscal(n),dp
      EXTERNAL derivs
      PARAMETER (NMAX=4)
CU    USES derivs,rkck
      INTEGER i
     ...
     *PSHRNK,ERRCON
      ...
      h=htry
1     call rkck(y,dydx,n,x,h,ytemp,yerr,derivs,dp)
      errmax=0.d0
      do 11 i=1,n
